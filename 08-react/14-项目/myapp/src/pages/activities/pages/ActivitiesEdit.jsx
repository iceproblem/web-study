...
export default class ActivitiesEdit extends Component {
    constructor(){
        ...
        this.activities_intro_ref = React.createRef();  // 活动介绍
        this.activities_trip_ref = React.createRef();   // 行程安排
        this.activities_days_ref = React.createRef();   // 开营日期
        this.activities_notice_ref = React.createRef(); // 报名须知
        ...
        this.state = {
            ...
            activities_id: '',  // 活动id
            activities_intro: '',   // 活动介绍
            activities_trip: '',    // 行程安排
            activities_days: '',    // 开营日期
            activities_notice: '',  // 报名须知
